...
def create_callbacks(training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            ...
            save_path = os.path.join(args.tensorboard_dir, 'eval_imgs')
...
def parse_args(args):
    ...
    parser.add_argument('--radar-mode', help='Mode for radar fusion \'add\' or \'concatenate\'')
...
def main(args=None):
    ...
    model, prediction_model = radefficientdet(args.phi,
    ...
    #     model,
    #     to_file="/mnt/TFM_KIKE/model.png",
    #     show_shapes=True,

...
class CSVGenerator(Generator):
    ...
    def __init__(
        ...
        self.radar_data = {filename: [os.path.splitext(filename)[0] + '_radar_P3.jpg',
                                      os.path.splitext(filename)[0] + '_radar_P4.jpg',
                                      os.path.splitext(filename)[0] + '_radar_P5.jpg',
                                      os.path.splitext(filename)[0] + '_radar_P6.jpg',
                                      os.path.splitext(filename)[0] + '_radar_P7.jpg',
                                      ] for filename in self.image_data.keys()}
        self.radar_data = OrderedDict(self.radar_data)
    ...
    def load_radar_images(self, image_index):
        ...
        radar_paths = [f'{os.path.splitext(image_path)[0]}_radar_P{i}.jpg' for i in range(3, 8)]
        radar_images = [cv2.imread(radar_path, cv2.IMREAD_GRAYSCALE) for radar_path in radar_paths]

        # radar_images = [cv2.cvtColor(image, cv2.COLOR_RGB2GRAY) for image in radar_images]
        return radar_images
